package com.cloutteam.rexcantor64.endwars.listeners;
...
import com.cloutteam.rexcantor64.endwars.utils.RandomManager;
...
public class BlockListener implements Listener {
	...
	public void onEmptyChestOpen(PlayerInteractEvent e) {
		...
		for (Entry<Integer, ItemStack> entry : RandomManager.get().getRandomItems(size).entrySet())
